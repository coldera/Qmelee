...
代价：-1体力上限",
    ...
    ["$guanwu"] = "沉睡吧",
    ["zhicai"] = "制裁",
    [":zhicai"] = "出牌阶段，你可以消耗18点怨，指定你以外任一角色发动。该角色进入【封牌】状态（角色面朝下且不能使用或打出任何手牌），直到受到伤害或经过X回合，X为存活角色数x3，每回合限用一次",
    ["$zhicai"] = "这是对神不敬的惩戒",
    ...
    ["guiyan"] = "鬼炎",
    [":guiyan"] = "出牌阶段，你可以消耗8点怨，指定任一其他角色进行判定，若为黑色，该角色进入【封牌】状态（角色面朝下且不能使用或打出任何手牌），直到回合结束，每回合限用一次",
    ["$guiyan"] = "怨魂缠绕，颤抖吧",
    ["yuanhun"] = "元魂",
