...
local t = {
    ...
    ["#AxeSkill"] = "%from 使用了盘古斧的技能，弃掉了2张牌以对 %to 强制命中", 
    ...
    ["$KingShieldNullify"] = "%from 装备<b style='color:yellow'>【仁王盾】</b>，%to 使用的 <b>%card</b> 对其无效",
    ["vine_armor"] = "藤甲", 
    [":vine_armor"] = "锁定技，无属性伤害对你无效。你每次受到火属性伤害时，该伤害+1。", 
    ["#VineArmorNullify"] = "%from 装备<b style='color:yellow'>【藤甲】</b>，无属性伤害对其无效", 
    ["#VineDamage"] = "%from 装备<b style='color:yellow'>【藤甲】</b>的负面技能被触发，由 %arg 点火焰伤害增加到 %arg2 点火焰伤害", 
    ["blood_guard"] = "血色守护", 
    [":blood_guard"] = "锁定技，你每次受到伤害时，最多承受1点伤害（防止多余的伤害）；当你失去装备区里的【血色守护】时，你回复1点体力。", 
    ["#BloodGuard"] = "%from 装备<b style='color:yellow'>【血色守护】</b>防止了 %arg 点伤害，减至1点", 
    ["holy_wing"] = "神佑光翼", 
    [":holy_wing"] = "锁定技，必须支付1点体力为代价才能装备，只要装备区有【神佑光翼】，属性伤害对你无效。", 
    ["#HolyWingCost"] = "%from 以减少1点体力为代价，使用<b>【神佑光翼】</b>", 
    ["#HolyWingNullify"] = "%from 装备<b style='color:yellow'>【神佑光翼】</b>，属性伤害对其无效", 
