...
return {
    ...
    ["$wuyu"] = "对伤痛已经没有感觉了",
    ["meiyu"] = "梅雨",
    [":meiyu"] = "出牌阶段，你可以消耗2点狂，弃置1张梅花手牌，摸2张牌",
    ["$meiyu"] = "小心点，我要开始认真了",
    ["baoyu"] = "暴雨",
    ...
    ["$roudan1"] = "呀~~地震来啦~", --发动时
    ["$roudan2"] = "算了，算了", --伤害小于2时
    ["#Roudan"] = "%from 对 %to 发动了技能<b style='color:yellow'>【肉弹】</b>",
    ["#RoudanMpUp"] = "%from 的<b style='color:yellow'>【肉弹】</b>技能造成的总伤害小于2，+1怒气",
    
    -- 2011-11-21 +AI+SE 守护村落的战士
    ["tamtam"] = "塔姆塔姆",
    ["~tamtam"] = "宝珠不见了，村子保护不了了....",
    ["mianju"] = "面具",
    [":mianju"] = "专属技，出牌阶段，可以使用任一装备牌为祭品，召唤【狂暴面具】到你的手牌中",
    ["$mianju1"] = "为了族人，我必须带上这个被诅咒的面具", --召唤时
    ["$mianju2"] = "（狂吼）", --造成伤害时
    ["$mianju3"] = "啊~ 头痛！", --弃牌时
    ["tuteng"] = "图腾",
    [":tuteng"] = "专属技，出牌阶段，可以使用任一非坐骑装备牌为祭品，召唤【萨满图腾】到你的手牌中；回合结束阶段，若不消耗1点狂，则弃置【萨满图腾】",
    ["$tuteng"] = "先祖们，请赐我力量！",
    ["#Mianju"] = "%from 发动专属技能，以1点体力为代价，召唤了<b style='color:yellow'>【狂暴面具】</b>",
    ["#Tuteng"] = "%from 发动专属技能，召唤了<b style='color:yellow'>【萨满图腾】</b>",
    ["tuteng_cost"] = "萨满图腾--祈祷",
    [":tuteng_cost"] = "消耗1点狂，防止【萨满图腾】弃置",
    ["#TutengCost"] = "%from 发动<b style='color:yellow'>【萨满图腾--祈祷】</b>效果，防止<b style='color:yellow'>【萨满图腾】</b>弃置 ",
    ["#TutengDiscard"] = "<b style='color:#CCCCCC'><b style='color:yellow'>【萨满图腾】</b>无法持续，消失在空气中</b>",
    
    -- 2011-11-23 +AI+SE 游荡的灵魂
    ["basara"] = "首斩破沙罗",
    ["~basara"] = "这次... 到底真的是死去了吗？",
    ["yuannian"] = "怨念",
    [":yuannian"] = "锁定技，当你即将死亡时，消耗10点怨，弃置所有手牌，回复至1点体力",
    ["$yuannian"] = "篝火... 要怎样才能再和你一起...",
    ["sinian"] = "思念",
    [":sinian"] = "回合开始阶段，你可以指定一名女性角色，称为【篝火】，场上只能有一名【篝火】。你每回复一次体力，【篝火】摸2张牌；【篝火】每受到一次伤害，你额外增加5点怨",
    ["$sinian1"] = "篝火... 真的是你吗！",
    ["$sinian2"] = "篝火... 不要再离开我了...",
    ["$sinian3"] = "（幻想：破沙罗！我也想你）",
    ["yingxi"] = "影吸",
    [":yingxi"] = "出牌阶段，你可以消耗6点怨，将角色翻面，进入【隐匿】状态（你不能成为【杀】的目标）X回合，X为当前存活角色数。每回合限用一次",
    ["$yingxi"] = "（消失在影子里.....）",
    ["yingchu"] = "影出",
    [":yingchu"] = "锁定技，【隐匿】状态解除时，你回复1点体力，并必须指定一名角色，视为对其使用【杀】",
    ["$yingchu"] = "咦~嘻嘻~",
    ["#Yuannian"] = "%from <b style='color:yellow'>【怨念】</b>技能被触发，再次从死亡中站起来",
    ["@sinian"] = "是否选择场上的一名女性角色，发动【思念】",
    ["#SinianDamage"] = "视为【篝火】的 %from 受到伤害，%to 怨念增加",
    ["#SinianRecover"] = "%from 回复体力，视为【篝火】的 %to 可以摸2张牌",
    ["#yingchu"] = "%from【隐匿】状态解除时，发动<b style='color:yellow'>【影出】</b>技能",
    ["@gouhuo"] = "篝火",
    
    -- 2011-11-27 -AI-SE 正与邪之间的男子
    ["amakusa"] = "天草四郎时贞",
    ["~amakusa"] = "世界... 已经无可救药了...",
    ["xieyou"] = "邪诱",
    [":xieyou"] = "出牌阶段，让任一其他角色选1种花色。若你弃置与所选花色的相同1张手牌，则目标角色失去1点体力，你+2点灵；否则你必须选择失去1点体力或-2点灵，每回合限用一次",
    ["$xieyou1"] = "来吧~ 跟我走，我可以给你最想要的...", --发动时
    ["$xieyou2"] = "哼哼... 吸收贪欲之气，真是一种享受...", --成功时
    ["$xieyou3"] = "啊，居然被识破了...", --失败时
    ["mozhang"] = "魔障",
    [":mozhang"] = "回合结束阶段，你可以消耗4点灵，弃置1张手牌，你进入【魔障】状态（其他角色不能将你做为单体战术牌使用的目标）X回合，X为场上存活角色数",
    ["$mozhang"] = "魑·魅·魍·魉 守护我身！",
    ["xiezhilingyu"] = "邪之领域",
    [":xiezhilingyu"] = "弃牌阶段，若弃置了战术牌，50%机率进入【封牌】状态2回合",
    ["XieyouLoseHp"] = "失去1点体力",
    ["XieyouLoseMp"] = "失去2点灵力",
    ["@xieyou-card"] = "是否弃置花色为 %arg 的1张手牌",
    ["@mozhang"] = "魔障",
    ["@askformozhang"] = "是否弃置一张手牌发动【魔障】",
    ["mozhang_effect"] = "魔障结界",
    [":mozhang_effect"] = "其他角色不能将你做为单体战术牌使用的目标",
