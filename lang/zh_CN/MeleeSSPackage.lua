...
return {
    ...
    -- 2011-11-22 -AI-SE 游荡的灵魂
    ["basara"] = "首斩破沙罗",
    ["~basara"] = "这次... 到底真的是死去了吗？",
    ["yuannian"] = "怨念",
    [":yuannian"] = "锁定技，当你即将死亡时，消耗10点怨，弃置所有手牌，回复1点体力",
    ["$yuannian"] = "篝火... 杀死你的人到底是谁...",
    ["sinian"] = "思念",
    [":sinian"] = "回合开始阶段，你可以指定一名女性角色，将该角色视为【篝火】，场上只能有一名【篝火】。你每回复1点体力，【篝火】摸1张牌；【篝火】每受到一次伤害，你额外增加5点怨",
    ["$sinian1"] = "篝火... 真的是你吗！",
    ["$sinian2"] = "篝火... 真的很想你啊...",
    ["$sinian3"] = "篝火... 要坚持住！",
    ["yingxi"] = "影吸",
    [":yingxi"] = "出牌阶段，你可以消耗6点怨，将角色翻面，进入【影吸】状态（你不能成为【杀】的目标）X回合，X为当前存活角色数。每回合限用一次",
    ["$yingxi"] = "（消失在影子里.....）",
    ["yingchu"] = "影出",
    [":yingchu"] = "锁定技，【影吸】状态解除时，你回复1点体力，并必须指定一名角色，视为对其使用【杀】",
    ["$yingchu"] = "咦~嘻嘻~",
