...
return {
    ...
    ["$yuelun"] = "神是无所不能的",
    ["siyue"] = "死月",
    [":siyue"] = "出牌阶段，你可以消耗2点灵，使任意1张牌当成【冰杀】使用，且不受【杀】的次数限制，每回合限用一次",
    ["$siyue"] = "觉悟吧",
    ["fengyin"] = "封印",
    [":fengyin"] = "回合结束阶段，你可以消耗3点灵，变身为【风间苍月】",
    ["$fengyin"] = "暂时休息一下",
    ["@fengyin"] = "是否变身为【风间苍月】",
    ...
    ["#YanmieFail"] = "%from <b style='color:yellow'>【炎灭--爆】</b>发动失败",
    ...
    ["$yingwu"] = "忍法--影分身",
    ["chenyin"] = "尘隐",
    [":chenyin"] = "必杀技，消耗3点气，与距离1以内的任一角色拼点，若你赢，造成目标角色1点伤害，并使其进入【封技】状态（所有技能不能发动）X回合，X为存活角色数x2",
    ["$chenyin"] = "秘技--爆炎~微尘隐",
    ["@kongchan"] = "是否发动【空蝉--天舞】弃1张装备牌，抵销这次伤害",
    ["kongchan-bang"] = "是否发动【空蝉--地听】对伤害来源使用【杀】",
