...
return {
    ...
    ["$XuanfengEffect"] = "%from 发动<b style='color:yellow'>【旋风】</b>技能，无效了 %to 使用的 %card",
    ...
    ["~sakura"] = "师父~你在哪里了",
    ["chongbai"] = "崇拜",
    [":chongbai"] = "出牌阶段，你可以将自己的1张手牌交给其他任一角色，你增加1点气",
    ["$chongbai"] = "跟定你了，教教我吧",
    ["mofang"] = "模仿",
    [":mofang"] = "出牌阶段，你可以从最近5张其他角色使用的非装备牌中挑选1张，然后从手牌中打出相同花色的牌当做选中的牌来使用，每回合限用一次",
    ["yingluo"] = "樱落",
