...
pkg.basic_snatch_choice=sgs.newStrategy{
	match=function(self,move)
		-- return move.card:inherits("Snatch") modify by ce
		return move.card:inherits("Grab")
	end,
	evaluate=function(self,move)
...
pkg.basic_god_salvationchoice=sgs.newStrategy{
	match=function(self,move)
		-- return move.card:inherits("GodSalvation") modify by ce
		return move.card:inherits("WoodElf")
	end,
	evaluate=function(self,move)
		local critical=0
		local yield=0
